                        ...
                        <x-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    <!-- Team Settings -->
                                    <x-dropdown-link-jet href="{{ route('teams.show', Auth::user()->currentTeam->id) }}">
                                        {{ __('Team Settings') }}
                                    </x-dropdown-link-jet>

                                    @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                                        <x-dropdown-link-jet href="{{ route('teams.create') }}">
                                            {{ __('Create New Team') }}
                                        </x-dropdown-link-jet>
                                    @endcan
                ...
                <div class="relative ms-3">
                    <x-dropdown-jet align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link-jet href="{{ route('profile.show') }}">
                                {{ __('Profile') }}
                            </x-dropdown-link-jet>

                            @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                                <x-dropdown-link-jet href="{{ route('api-tokens.index') }}">
                                    {{ __('API Tokens') }}
                                </x-dropdown-link-jet>
                            @endif
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                ...
                                <x-dropdown-link-jet href="{{ route('logout') }}"
