                ...
                <div class="space-y-4">
                    ...
                    <div class="grid gap-3 lg:grid-cols-2">
                        <x-mary-choices-offline label="Tipo de Documento" :options="$documentTypes"
                            wire:model='form.document_type' single />
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="mt-2 text-xs font-semibold text-violet-700"
                            x-show="$wire.form.is_PEP && !($wire.form.wife_is_PEP || $wire.form.relative_is_PEP)"
                            x-transition>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs font-semibold text-violet-700"
                            x-show="$wire.form.wife_is_PEP && !($wire.form.is_PEP || $wire.form.relative_is_PEP)"
                            x-transition>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs font-semibold text-violet-700"
                            x-show="!$wire.form.is_PEP && $wire.form.relative_is_PEP && !$wire.form.wife_is_PEP"
                            x-transition>
                        ...
                        <p class="mt-2 text-xs font-semibold text-violet-700"
                            x-show="$wire.form.wife_is_PEP && $wire.form.relative_is_PEP && !$wire.form.is_PEP"
                            x-transition>
