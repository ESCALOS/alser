<x-mary-form wire:submit='save'>
    <div class="space-y-4">
        ...
        <div x-data="{ shareHolders: $wire.entangle('form.shareHolders') }">
            <template x-for="(shareHolder, index) in shareHolders" :key="index">
                <div>
                    <h3 class="font-semibold border-b-2 border-gray-900 text-md" x-text="'Accionista '+(index+1)">
                    </h3>
                    <div class="grid grid-cols-2 gap-2 py-4 md:grid-cols-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" :id="'shareHolders.' + index + '.name'"
                                class="w-full max-w-xs input input-bordered input-primary" x-model='shareHolder.name' />
                        </div>
                        <div>
                            <label for="shareHolder.documentType" class="pt-0 font-semibold label label-text">
                                Tipo de documento
                            </label>
                        ...
                        <div>
                            <label for="shareHolder.documentNumber" class="pt-0 font-semibold label label-text">
                                Número de documento
                            </label>
        ...
        <div class="grid gap-3 lg:grid-cols-2">
            <x-mary-choices-offline label="Tipo de Documento" :options="$documentTypesExceptRuc" wire:model='form.documentType' single />
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <p class="mt-2 text-xs font-semibold text-violet-700"
                x-show="$wire.form.wifeIsPEP && $wire.form.relativeIsPEP && !$wire.form.isPEP" x-transition>
    ...
    <div x-data="{ uploading: false, uploaded: false, progress: 0 }" x-on:livewire-upload-start="uploading = true, uploaded = false"
        ...
        <input x-ref="pdfPEP" type="file" class="hidden" wire:model='form.pdfPEP' accept="application/pdf">
