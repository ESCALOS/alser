<div class="animate-zoom-in" x-data="{ active: true }">
    <div class="flex justify-center w-full">
        <div class="flex justify-between bg-white border-2 border-gray-300 rounded-full w-96">
            <div class="w-1/2 py-2 text-lg font-semibold text-center rounded-full cursor-pointer" @click="active = true"
                :class="active ? 'bg-home-primary text-white' : 'text-gray-700'">Cotizador</div>
            <div class="w-1/2 py-2 text-lg font-medium text-center rounded-full cursor-pointer" @click="active = false"
                :class="!active ? 'bg-home-primary text-white' : 'text-gray-700'"><span class="font-extrabold">ALSER</span> promos
            </div>
        </div>
    </div>
    <div class="flex">
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow w-96 dark:bg-gray-800 dark:border-gray-700">
            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg justify-evenly bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800" role="tablist">
                <li class="me-2">
                    <button type="button" @click="purchase = true" role="tab" class="inline-block pt-4 font-black rounded-ss-lg" :class="purchase ? 'text-home-primary border-b border-indigo-700' : 'text-gray-600'">
                        Dólar Compra <br> <span class="font-bold text-md" x-text="$wire.purchaseFactor"></span>
                    </button>
                </li>
                <li class="me-2">
                    <button type="button" @click="purchase = false" role="tab" class="inline-block pt-4 font-black rounded-ss-lg" :class="!purchase ? 'text-home-primary border-b border-indigo-700' : 'text-gray-600'">
                ...
                <div class="w-full">
                    ...
                    <div class="relative p-4">
                        <div class="grid grid-cols-5 border border-indigo-700 rounded-2xl">
                            <div class="flex items-center justify-center col-span-2 rounded-2xl bg-indigo-50">
                            ...
                            <div class="col-span-3 text-indigo-900">
                                ...
                                <div class="flex items-center text-xl font-medium text-indigo-900">
                                    <div class="px-4">$ </div>
                                    <div>
                                        <input class="pt-0 ml-4 text-lg text-right border-none rounded-2xl w-28 md:w-32" x-model="dolarAmount" @input="updateSolAmount" style="box-shadow: none" type="text" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!--icon exnchage-->
                        <div class="absolute flex items-center content-center justify-center cursor-pointer top-16 left-28" @click="purchase = !purchase">
                            <div class="transition-all duration-300 rounded-full bg-home-primary w-14 h-14 hover:rotate-180 hover:bg-violet-900">
                        ...
                        <div class="grid grid-cols-5 mt-6 border border-home-primary rounded-2xl">
                            ...
                            <div class="col-span-3 text-indigo-900">
                                ...
                                <div class="flex items-center text-xl font-medium text-indigo-900">
                                    ...
                                    <div>
                                        <input x-model="solAmount" @input="updateDolarAmount" class="pt-0 text-lg text-right border-none rounded-2xl w-28 md:w-32" style="box-shadow: none" type="text" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a class="block w-full px-6 py-4 my-6 text-lg text-white transition-colors duration-300 rounded-sm bg-home-primary hover:bg-violet-900" wire:navigate href="{{ route('dashboard') }}">
                            Iniciar operación
                        </a>
            ...
            <div class="flex flex-col items-center justify-around p-4 h-96">
                ...
                <div>
                    <div class="text-base text-gray-900 text-pretty">
                        Los <b>ALSERPROMOS</b> te permiten acceder a un tipo de cambio insuperable, específicos y por monto mínimo.
                    </div>
                    <div class="py-4 text-gray-500 text-md">
                        Estas promociones son por tiempo limitado.
                    </div>
                    <a class="block w-full px-6 py-4 text-xl text-white transition-colors duration-300 rounded-sm bg-home-primary hover:bg-violet-900" wire:navigate href="{{ route('dashboard') }}">
                        Ir al cotizador
                    </a>
                </div>
            </div>
