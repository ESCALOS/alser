    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto lg:justify-between">
        ...
        <div>
            <div class="flex items-center lg:order-2">
                <button @click="open = !open" @resize.window="screenSize = window.matchMedia('(max-width: 1023px)').matches" type="button"
            ...
            <div x-show="screenSize ? open : true"
                ...
                <ul
                    class="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg bg-home-primary lg:p-0 lg:flex-row lg:space-x-8 lg:mt-0 lg:border-0 lg:bg-home-primary dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700">
                    @foreach ($routes as $route)
                        <li class="{{ request()->routeIs($route['route']) ? 'lg:border-b lg:border-white' : 'lg:hover:border-b lg:hover:border-white'}}">
                    ...
                    @endforeach
                    <li class="lg:hover:border-b lg:hover:border-white">
