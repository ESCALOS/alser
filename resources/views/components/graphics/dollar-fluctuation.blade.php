<section class="py-8 bg-gray-100 md:py-12">
    ...
    <div class="grid max-w-screen-xl grid-cols-1 gap-4 px-6 pt-6 mx-auto md:grid-cols-2">
        <livewire:graphics.dollar-fluctuation :prices="$prices" :isPurchase="true" :lastPriceYesterday="$lastPriceYesterday" />
        <livewire:graphics.dollar-fluctuation :prices="$prices" :isPurchase="false" :lastPriceYesterday="$lastPriceYesterday" />
    </div>
</section>
