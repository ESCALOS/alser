<x-mary-card>
    ...
    <p class="my-4">
        Has seleccionado una cuenta de <b>origen</b> BCP de provincia. Ten en consideración que:
    <ul class="pl-6 list-disc">
        ...
        <li>
            <b>Solo puede usar el canal web o app del BCP para realizar la transferencia.</b> De lo contrario, te
            devolveremos el dinero, descontando las comisiones cobradas por el banco.
        </li>
    </ul>
    </p>
    <p class="my-4">
        Has seleccionado una cuenta de <b>destino</b> BCP de provincia. Ten en consideración que:
    <ul class="pl-6 list-disc">
        <li>
